...
![GBK](/assets/images/201911/GBK.gif)
...
** 2. Herb Sutter 给出了明确的建议：对函数使用重载，对类模板进行特化。[refer: Herb Sutter, “Why not specialize function templates?”](http://www.gotw.ca/publications/mill17.htm)**
