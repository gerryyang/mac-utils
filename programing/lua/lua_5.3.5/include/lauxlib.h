...
/*
** ==============================================================
** For export table extension: create a lua state and assign
** its hash seed by parameter (unsigned int seed)
** ==============================================================
*/
